...
## v162 — TRUE CORE 3 ENGINE FIX

- Corrected Core rule: Core 3 always fills from top 3 true event owners after Blender elimination.
- Removed the bad empty-Core behavior.
- Roles are truthful labels only: Primary / Adjacent / WHO.
- No fake REFILL labels.
- Scores spread wider using event ownership + gate depth + deterministic player/game separation.
- Game Board still exposes PASS/CUT lineage.
