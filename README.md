...
## v147 — Feed + Engine Repair
- PDF feeder extracts hitter rows only, not raw line junk.
- CSV feeder normalizes app-ready hitter columns.
- Engine accepts HR/PA, DMG, HPI, line, condition, pitch edge, and tags to create owners.
