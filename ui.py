...
/* START = hidden PDF uploader over yellow START tile */
...
/* REAL run controls, visible and clickable */
.status-box{
  position:fixed!important;
  left:14px!important;
...
.stButton > button{
  ...
  box-shadow:0 0 18px rgba(251,191,36,.8)!important;
}
</style>
