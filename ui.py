...
# =========================================================
# FINAL ROADMAP GAMEBOARD UI INTEGRATION
# =========================================================

UI_ROADMAP_SYSTEM = {
    "phase1_visual_shell": {
        "exact_gameboard_layout": True,
        "glassmorphism_board_tiles": True,
        "core_alt_who_styling": True,
        "archetype_pill_visuals": True,
        "chaos_meter_styling": True,
        "spacing_readability": True
    },
    "phase2_hierarchy": {
        "survivor_hierarchy": True,
        "lock_states": True,
        "confidence_stacks": True,
        "visual_elimination_states": True,
        "game_importance_weighting": True
    },
    "phase3_intelligence_visuals": {
        "clickable_gameboard_tiles": True,
        "intelligence_panels": True,
        "spread_detection_visuals": True,
        "elimination_timeline": True,
        "ownership_flow_visuals": True
    },
    "phase4_live_flow": {
        "live_flow_hooks": True,
        "ownership_tracking": True,
        "survivor_evolution": True,
        "dynamic_confidence": True,
        "chaos_override_visuals": True
    }
}

ROADMAP_UI_THEME = '''
- SAME roadmap board preserved
- SAME engine preserved
- SAME V2seventy structure preserved
- ONLY ui.py upgraded
- No rebuild drift
'''
