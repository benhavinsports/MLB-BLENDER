...
.road-row{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:12px;}
.road-tile{
width:90px;min-height:76px;
border-radius:16px;
...
.tile-blue{background:linear-gradient(160deg,#2563eb,#1d4ed8);}
.tile-red{background:linear-gradient(160deg,#dc2626,#991b1b);}
.tile-orange{background:linear-gradient(160deg,#f97316,#c2410c);}
.tile-green{background:linear-gradient(160deg,#22c55e,#15803d);}
.tile-purple{background:linear-gradient(160deg,#9333ea,#6b21a8);}
...
.core-card{border-top:4px solid #36d399;}
.alt-card{border-top:4px solid #fbbf24;}
.who-card{border-top:4px solid #f87171;}
.owner-title{font-size:22px;font-weight:900;margin-bottom:6px;}
.archetype-pill{
display:inline-flex;
padding:5px 10px;
border-radius:999px;
...
<div class="blender-board">
    <div class="road-row">
        <div class="road-tile tile-blue">CORE MATCHUP</div>
        <div class="road-tile tile-red">VEGAS</div>
        <div class="road-tile tile-orange">STARTER</div>
        <div class="road-tile tile-purple">BALLPARK</div>
        <div class="road-tile tile-red">WEATHER</div>
        <div class="road-tile tile-orange">DISCIPLINE</div>
        <div class="road-tile tile-blue">HARD HIT</div>
        <div class="road-tile tile-green">BARREL</div>
        <div class="road-tile tile-purple">SURVIVOR CUT</div>
        <div class="road-tile tile-green">OWNER LOCK</div>
    </div>
...
""", unsafe_allow_html=True)
    ...
    with c1:
        with st.expander("Spread Detection"):
            st.markdown('<div class="intel-panel">Detects spread environments and false-clean traps.</div>', unsafe_allow_html=True)

    with c2:
        with st.expander("Finisher DNA"):
            st.markdown('<div class="intel-panel">Tracks true HR conversion behavior and ownership finishing.</div>', unsafe_allow_html=True)

    with c3:
        with st.expander("Event Ownership"):
            st.markdown('<div class="intel-panel">Models pressure transfer and final owner isolation.</div>', unsafe_allow_html=True)
