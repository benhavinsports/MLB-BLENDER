...
def blender_machine(names):
    ...
    st.markdown(f"""<div class="machine"><div class="blender-wrap"><div class="feed-slot">FEED DATA HERE</div><div class="jar"><div class="blade"></div><div class="center">READY</div>{floats}</div><div class="output-slot">BLADES SPIN → OWNERS LOCK → TICKETS POP OUT</div></div></div>""", unsafe_allow_html=True)
