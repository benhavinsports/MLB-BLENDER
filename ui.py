...
<div class="board">
  ...
  <div class="footer"><div>START Upload</div><div>Hidden 23 Gates</div><div>Dynamic Tiles</div><div>Core / Alt / Chaos</div><div>FINISH Run</div></div>
