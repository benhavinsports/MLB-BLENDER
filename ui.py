...
.big-title{font-size:52px;font-weight:1000;line-height:.92;letter-spacing:2px;margin:22px 0 34px 0;}
...
.role-pill{display:inline-block;border:1px solid #444;border-radius:999px;padding:4px 9px;margin:4px 4px 4px 0;font-size:7px;}
...
.board-canvas{
  position:relative;width:min(720px, 92vw);height:500px;
...
.board-header{position:absolute;left:10px;right:10px;top:10px;height:48px;display:grid;grid-template-columns:160px 1fr 86px 86px 86px;gap:7px;align-items:center;z-index:5;}
.board-logo{display:flex;gap:6px;align-items:center;color:#fff6e7;font-weight:1000;letter-spacing:.7px;line-height:.95;font-size:15px;}
.board-logo-mark{width:28px;height:28px;border-radius:12px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.045);display:flex;align-items:center;justify-content:center;font-size:16px;box-shadow:0 0 24px rgba(64,150,255,.20);}
.board-menu{width:26px;height:26px;border-radius:8px;border:1px solid rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;color:#aeb7c5;margin-right:10px;}
.board-logo-wrap{display:flex;align-items:center;}
.top-stat{height:28px;background:rgba(8,12,18,.78);border:1px solid rgba(255,255,255,.11);border-radius:10px;color:#e7edf5;display:flex;align-items:center;justify-content:center;text-align:center;font-weight:900;font-size:8px;line-height:1.15;}
.top-stat .green{color:#35ff63;font-size:12px;display:block;}
.road{position:absolute;left:34px;right:76px;height:72px;border:16px solid #020202;border-radius:48px;z-index:1;pointer-events:none;}
.road.r1{top:88px;border-left:0;border-top:0;}
.road.r2{top:205px;border-right:0;border-bottom:0;}
.road.r3{top:330px;border-left:0;border-top:0;right:130px;}
.arrow{position:absolute;color:white;font-size:26px;z-index:4;font-weight:1000;text-shadow:0 4px 10px rgba(0,0,0,.7);}
.arrow.a1{left:72px;top:112px;transform:rotate(225deg);}
.arrow.a2{left:350px;top:172px;}
.arrow.a3{right:112px;top:286px;transform:rotate(45deg);}
.tile{position:absolute;width:58px;height:48px;border-radius:5px;border:2px solid rgba(255,255,255,.92);color:white;text-align:center;display:flex;flex-direction:column;align-items:center;justify-content:center;box-shadow:0 7px 18px rgba(0,0,0,.46),inset 0 1px 0 rgba(255,255,255,.2);transform:skewX(-3deg);z-index:3;overflow:hidden;}
...
.tile-num{width:15px;height:15px;border-radius:50%;background:#fff8ef;color:#080d15;font-weight:1000;font-size:7px;display:flex;align-items:center;justify-content:center;margin-bottom:5px;z-index:2;}
.tile-label{font-size:6.5px;line-height:1.05;font-weight:1000;z-index:2;text-shadow:0 1px 3px rgba(0,0,0,.55);}
...
.start-tile{position:absolute;left:12px;top:74px;width:70px;height:48px;border-radius:7px;background:linear-gradient(160deg,#ffc527,#f59e0b);border:4px solid #fff8ef;color:white;font-size:17px;font-weight:1000;display:flex;align-items:center;justify-content:center;transform:rotate(-6deg);z-index:4;text-shadow:0 2px 7px rgba(0,0,0,.3);box-shadow:0 9px 20px rgba(0,0,0,.45);}
.finish-star{position:absolute;right:10px;top:300px;width:86px;height:80px;background:linear-gradient(160deg,#ffda30,#ff9900);clip-path:polygon(50% 0%,61% 25%,88% 13%,76% 39%,100% 50%,76% 61%,88% 87%,61% 75%,50% 100%,39% 75%,12% 87%,24% 61%,0% 50%,24% 39%,12% 13%,39% 25%);z-index:6;display:flex;align-items:center;justify-content:center;text-align:center;color:white;font-size:12px;font-weight:1000;line-height:1.05;filter:drop-shadow(0 8px 10px rgba(0,0,0,.55));text-shadow:0 2px 5px rgba(0,0,0,.28);}
.legend{position:absolute;left:245px;top:270px;width:240px;min-height:54px;background:rgba(4,8,14,.90);border:1px solid rgba(255,255,255,.15);border-radius:12px;z-index:5;color:#cfd7e5;font-size:6.5px;font-weight:800;padding:8px 10px;display:grid;grid-template-columns:1fr 1fr;gap:4px 8px;}
.legend-title{grid-column:1/-1;color:white;font-size:6.5px;}
.dot{width:11px;height:11px;border-radius:3px;display:inline-block;margin-right:6px;vertical-align:-1px;}
.owner-row{position:absolute;left:10px;right:10px;top:398px;height:92px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;z-index:5;}
.owner-card{background:rgba(7,12,20,.86);border:1px solid rgba(255,255,255,.11);border-radius:10px;padding:8px 10px;color:#eaf0f8;box-shadow:0 12px 30px rgba(0,0,0,.4);overflow:hidden;}
...
.owner-kicker{font-size:6.5px;font-weight:1000;letter-spacing:.5px;text-transform:uppercase;margin-bottom:8px;}
.owner-kicker.core{color:#347dff;}
.owner-kicker.alt{color:#ff3f4d;}
.owner-kicker.who{color:#4cff7d;}
.locked-pill{float:right;background:rgba(34,197,94,.18);border:1px solid rgba(92,255,120,.55);color:#d9ffdd;border-radius:999px;padding:4px 9px;font-size:6px;font-weight:1000;}
.owner-name{font-size:8px;font-weight:1000;color:white;margin-bottom:2px;}
.owner-role{font-size:6.5px;font-weight:850;color:#eef2f8;}
.owner-game{font-size:6.5px;color:#b9c2cf;line-height:1.22;}
.owner-vs{font-size:6.5px;font-weight:900;margin-top:7px;}
.owner-vs.core{color:#5aa2ff;}
.owner-vs.alt{color:#ff4c58;}
.owner-vs.who{color:#5cff82;}
.board-footer{position:absolute;left:10px;right:10px;bottom:8px;height:28px;border-top:1px solid rgba(255,255,255,.08);display:grid;grid-template-columns:1.1fr 1.1fr 1.2fr 1.2fr 1fr;gap:8px;color:#aab3c1;font-size:6.5px;align-items:center;z-index:5;}
.footer-item{border-left:1px solid rgba(255,255,255,.10);padding-left:14px;line-height:1.1;}
.footer-item b{display:block;color:#f4f8ff;font-size:6.5px;}
@media(max-width:800px){.big-title{font-size:58px;}.board-scroll{padding-bottom:8px;}}
...
GATES = [
    (1,"Core<br>Matchup<br>Filter","t-blue",90,74),(2,"Vegas Line<br>Screen","t-red",153,74),(3,"Opponent<br>Starter<br>Screen","t-orange",216,74),(4,"Ballpark<br>Factor<br>Gate","t-purple",279,74),(5,"Weather<br>Gate","t-red",342,74),(6,"Plate<br>Discipline<br>Gate","t-orange",405,74),(7,"Hard Hit<br>% Gate","t-blue",468,74),(8,"Barrel<br>% Gate","t-green",531,74),(9,"wOBA<br>Gate","t-purple",600,93),(10,"xwOBA<br>Gate","t-green",600,155),(11,"ISO<br>Power<br>Gate","t-red",533,205),(12,"Pitches Per<br>PA Gate","t-green",470,205),(13,"Swing<br>% Gate","t-purple",407,205),(14,"Chase<br>% Gate","t-blue",344,205),(15,"K %<br>Contact<br>Gate","t-orange",281,205),(16,"Batted Ball<br>Profile<br>Gate","t-red",218,205),(17,"Clutch / Leverage<br>Opportunity<br>Gate","t-green",155,205),(18,"Lineup<br>Position<br>Gate","t-purple",32,205),(19,"Consistency<br>Stability<br>Gate","t-blue",32,267),(20,"Recent Form<br>Gate","t-orange",96,327),(21,"Fade / Low<br>EV Filter<br>Gate","t-red",188,327),(22,"Final<br>Survivor<br>Cut","t-purple",280,327),(23,"LIVE<br>BLENDER","t-green",371,327)
]
  ...
  <div class="board-canvas">
    <div class="board-header">
      <div class="board-logo-wrap">
        ...
        <div class="board-logo"><div class="board-logo-mark">⚙</div><div>PUBLIC<br><span style="font-size:8px;">BLENDER BOARD</span></div></div>
      </div>
...
<div class="ticket-card">
  ...
  <div style="font-size:15px;font-weight:900">{_esc(name)}</div>
