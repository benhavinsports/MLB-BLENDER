...
/* Hidden Streamlit uploader is now directly over the yellow START tile */
...
<div class="board">
  <div class="top">
    ...
    <div class="pill" id="uploadName">Today’s Slate</div>
...
function renderTop(){
  document.getElementById("uploadName").textContent=data.uploaded?("Loaded: "+data.uploaded):"Today’s Slate";
