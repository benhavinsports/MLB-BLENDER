  ...
  <div class="board-canvas">
    <div class="board-header">
      <div class="board-logo-wrap">
        ...
        <div class="board-logo"><div class="board-logo-mark">⚙</div><div>BLENDER<br><span style="font-size:14px;">GAMEBOARD</span></div></div>
      </div>
      <div class="top-stat">📅 &nbsp; {slate}</div>
      <div class="top-stat">Total Hitters<span class="green">{total}</span></div>
    ...
    <div class="legend">
      ...
      <div><span class="dot" style="background:#1769ff"></span>Matchup & Environment</div>
      <div><span class="dot" style="background:#e11d2f"></span>Offense Quality</div>
      <div><span class="dot" style="background:#f97316"></span>Plate Discipline</div>
      <div><span class="dot" style="background:#20b455"></span>Power & Contact Quality</div>
      <div><span class="dot" style="background:#7c2bd0"></span>Context & Consistency</div>
      <div>🔒 Final Selection</div>
    </div>
    <div class="finish-star">FINISH<br>🔒<br>LOCKED<br>OWNERS</div>
    <div class="owner-row">{owner_html}</div>
    <div class="board-footer">
      <div class="footer-item">📅 <b>Blender Engine</b>{version}</div>
      <div class="footer-item">🛡️ <b>23-Gate Progression</b>All Gates Active</div>
      ...
      <div class="footer-item">✅ <b>Owners Locked</b>Board Complete</div>
    </div>
  </div>
</div>
'''
