...
def blender_visual(results=None):
    ...
    coords=[(119,104),(203,103),(287,103),(371,104),(455,106),(540,108),(624,111),(708,116),(797,135),(825,206),(765,272),(681,281),(596,287),(510,291),(426,294),(342,299),(257,305),(172,318),(77,350),(86,430),(196,485),(348,493),(515,491)]
...
<style>
*{{box-sizing:border-box}}html,body{{margin:0;background:#000;color:#fff;font-family:Arial,Helvetica,sans-serif;overflow:hidden}}.frame{{width:100%;height:100vh;background:#000;display:flex;justify-content:center;align-items:flex-start}}.board{{width:960px;height:560px;background:#020409;position:relative;overflow:hidden;transform-origin:top center}}
.top{{position:absolute;left:12px;right:12px;top:10px;height:58px;display:grid;grid-template-columns:245px 250px 150px 150px;gap:18px;align-items:center;z-index:5}}.brand{{display:flex;gap:10px;align-items:center;font-weight:900}}.logo{{width:42px;height:42px;border-radius:13px;border:1px solid rgba(255,255,255,.22);display:flex;align-items:center;justify-content:center;font-size:24px}}.brand-title{{font-size:21px;line-height:.9}}.brand-small{{font-size:10px;letter-spacing:2px;color:#d4d8e2}}.top-card{{height:48px;border:1px solid rgba(255,255,255,.17);background:#070d17;border-radius:9px;text-align:center;display:flex;align-items:center;justify-content:center;flex-direction:column;font-size:12px;font-weight:800;color:#dce7f7}}.top-card b{{font-size:21px;color:#76f184}}
.track-svg{{position:absolute;left:18px;top:78px;width:910px;height:385px;z-index:1}}.start{{position:absolute;left:16px;top:84px;width:102px;height:72px;z-index:6;background:linear-gradient(160deg,#ffe66d,#e5a91f);border:4px solid white;border-radius:9px;transform:rotate(-5deg);font-size:26px;color:white;font-weight:900;text-shadow:0 2px 4px #000;display:flex;align-items:center;justify-content:center}}.finish{{position:absolute;right:28px;top:332px;width:116px;height:116px;z-index:6;background:#f2bc2b;clip-path:polygon(50% 0%,61% 31%,94% 18%,74% 48%,100% 65%,67% 69%,79% 100%,50% 80%,21% 100%,33% 69%,0 65%,26% 48%,6% 18%,39% 31%);display:flex;align-items:center;justify-content:center;text-align:center;font-weight:900;font-size:23px;text-shadow:0 2px 3px #000}}
.gate{{position:absolute;width:82px;height:64px;z-index:5;border:2px solid rgba(255,255,255,.78);color:#fff;border-radius:4px;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;font-weight:900;padding:3px;box-shadow:0 2px 8px rgba(0,0,0,.45);cursor:pointer}}.gate.core{{box-shadow:0 0 24px rgba(64,130,255,.95)}}.gate.alt{{box-shadow:0 0 24px rgba(255,60,60,.9)}}.gate.chaos{{box-shadow:0 0 24px rgba(55,255,105,.9),0 0 12px rgba(168,85,247,.55)}}.bubble{{position:absolute;top:3px;left:50%;transform:translateX(-50%);background:white;color:#111;width:20px;height:20px;border-radius:999px;display:flex;align-items:center;justify-content:center;font-size:10px}}.gate b{{font-size:9px;margin-top:17px;line-height:1.05;max-height:20px;overflow:hidden}}.gate small{{font-size:7px;line-height:1;opacity:.95;max-height:22px;overflow:hidden}}
.legend{{position:absolute;left:360px;top:296px;width:238px;height:62px;border:1px solid rgba(255,255,255,.15);border-radius:10px;background:#03060d;z-index:7;padding:9px;font-size:8px;color:#cbd5e1}}.result-row{{position:absolute;left:12px;right:12px;bottom:46px;height:104px;display:grid;grid-template-columns:repeat(3,1fr);gap:10px;z-index:7}}.result-card{{text-align:left;background:#050a13;border:1px solid rgba(255,255,255,.14);border-radius:10px;padding:11px;position:relative;overflow:hidden;color:white;cursor:pointer}}.result-card.core{{box-shadow:0 0 18px rgba(59,130,246,.7);border-color:#1d4ed8}}.result-card.alt{{box-shadow:0 0 18px rgba(239,68,68,.7);border-color:#dc2626}}.result-card.chaos{{box-shadow:0 0 18px rgba(34,197,94,.7);border-color:#16a34a}}.lock{{position:absolute;right:8px;top:8px;border-radius:999px;background:#166534;color:white;padding:3px 7px;font-size:7px;font-weight:900}}.role{{font-size:9px;font-weight:900;margin-bottom:6px}}.name{{font-size:19px;font-weight:900;line-height:1;color:#fff}}.sub{{font-size:9px;font-weight:800;color:#d8e2f0;margin-top:5px}}.game-line{{font-size:8px;color:#c4ccd8;margin-top:5px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}}.pitcher{{font-size:8px;color:#8be38e;margin-top:5px}}.foot{{position:absolute;left:0;right:0;bottom:0;height:36px;border-top:1px solid rgba(255,255,255,.09);display:grid;grid-template-columns:repeat(5,1fr);z-index:7;background:#03050a;color:#b8c1ce;font-size:9px;font-weight:800;text-align:center;align-items:center}}
...
def card(r, extra=""):
    ...
    st.markdown(f"<div class='ticket-card'><div class='score-pill'>{score}</div><div style='font-size:24px;font-weight:900'>{name}</div><div style='opacity:.94;font-weight:800'>{display_role} · {arch}</div><div style='opacity:.82'>{game} {('· '+time) if time else ''}</div><div style='opacity:.72'>vs {pitcher}</div>{('<div style=\"opacity:.75;margin-top:8px\">'+str(extra)+'</div>') if extra else ''}</div>", unsafe_allow_html=True)
