...
def game_board_view(results, key_prefix="gb"):
    ...
    if survivors is not None and not survivors.empty:
        ...
        cols=[c for c in ["page","game","game_key","player","team","pitcher","official_core_role","archetype","score","gate_grade","hard_fails","soft_fails","gate_path"] if c in survivors.columns]
