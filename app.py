...
from ui import start_upload_header, public_start_upload_panel, inject_css, hero, blender_visual, tickets_view, game_board_grid_view

st.set_page_config(page_title="THE BLENDER", page_icon="🔥", layout="wide", initial_sidebar_state="collapsed")
inject_css(); hero()
public_start_upload_panel()
...
with tabs[0]:
    blender_visual()
    uploaded = start_upload_header()
st.file_uploader("FEED DATA HERE", type=["pdf","csv","xlsx","xls","txt","md"], label_visibility="collapsed")
