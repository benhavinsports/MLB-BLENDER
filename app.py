...
<div class="hero"><h1>THE <span class="hot">BLENDER</span><br/>RESULT ENGINE</h1><p>Data first. UI second. This version fixes CSV mapping, true score bars, team/pitcher carry-through, missing-data visibility, and hard penalties for empty profiles.</p><span class="chip">Official 0 → 18</span><span class="chip">10.5 in sequence</span><span class="chip">One owner per game</span><span class="chip">No revivals</span></div>
""", unsafe_allow_html=True)
