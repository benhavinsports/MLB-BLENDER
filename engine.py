...
APP_ENGINE_VERSION = "v132_CLEAN_UNIFIED_RUNTIME"
...
def evaluate_candidates(df):
    ...
    out["fresh_note"] = out.apply(
        ...
        else ("REPEAT_ROTATED_DOWN" if _key(r.get("player","")) in RECENT_REPEAT_NAMES else "FRESH_PROFILE"),
        axis=1
    )
    ...
    out = out[out["event_role"].ne("CUT")].copy()
