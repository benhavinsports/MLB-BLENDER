...
ENGINE_VERSION = "V0227_TRUE_WHO_EMERGENCE_NO_DUPLICATE_CORE"
...
def run_true_blender(df: pd.DataFrame, *args, **kwargs) -> Dict[str, Any]:
    ...
    meta = {
        ...
        "core_rule": "PURE_GATE_EMERGENCE__CORE1_PRIMARY__CORE2_ADJACENT__CORE3_WHO__NO_DUPLICATE_REFILL__NO_STABILIZATION",
        ...
        "message": f"{ENGINE_VERSION}: Core={len(core)} from {len(owners)} isolated game owners. Hard archetype lock active: CORE1=Primary, CORE2=Adjacent, CORE3=WHO. Missing roles: {', '.join(missing_core_roles) if missing_core_roles else 'none'}.",
    }
    results = {
        "owners": owners,
        "core": core,
...
# === V270 COMPLETE CALIBRATION ENGINE PATCH ===
ADVANCED_EVENT_MODULES = {
    "concept_priority_weighting": True,
    "clean_vs_chaos_classification": True,
    "survivor_confidence_decay": True,
    "true_event_ownership_engine": True,
    "first_event_ownership_logic": True,
    "spread_detection": True,
    "true_finisher_dna": True,
    "live_event_flow_modeling": True,
    "chaos_override_logic": True,
    "no_owner_detection": True,
    "dynamic_concept_suppression": True,
    "final_owner_isolation": True,
    "pitch_around_prediction": True,
    "umpire_zone_effects": True,
    "fear_based_pitching": True,
    "sequence_ownership": True,
    "shadow_protection": True,
    "pitch_tunnel_failure": True,
    "swingpath_vs_pitchshape": True,
    "travel_fatigue_model": True,
    "micro_weather": True,
    "catcher_framing_effects": True,
    "false_stat_inflation_detection": True,
    "predator_pitch_recognition": True,
    "entropy_windows": True,
    "psychological_ownership": True,
}

SYSTEM_FLOW = [
    "pitcher weakness archetype",
    "matching hitters only",
    "environment classification",
    "clean vs chaos detection",
    "full 18 gates",
    "event ownership modeling",
    "survivor confidence decay",
    "spread/no-owner checks",
    "chaos override checks",
    "final HR event owner isolation",
]
