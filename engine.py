...
def run_true_blender(df,*args,**kwargs):
    ...
    meta={"input_rows":0 if df is None else len(df),"games":actual_game_count(df),"owners_locked":0,"survivor_rows":0,"no_play_games":0,"message":"","engine_version":"v106_TICKET_STRUCTURE_LOCK"}
