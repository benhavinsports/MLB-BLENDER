...
LOCK_FILE = DATA_DIR / "locked_owners.json"
RECAP_LOG_FILE = DATA_DIR / "recap_log.csv"
...
# -------------------- FIXED REQUIRED ENGINE CONSTANTS --------------------
SAVANT_BATTER_CACHE = DATA_DIR / "savant_batter_cache.csv"
ADAPTIVE_WEIGHTS_FILE = DATA_DIR / "adaptive_gate_weights.json"

FULL_LIVE_METRIC_ALIASES = {
    "player": ["player", "player_name", "batter", "name"],
    "mlb_id": ["mlb_id", "player_id", "id"],
    "pull_pct": ["pull_pct", "pull_percent", "pull%", "pull_percentile"],
    "sweet_spot_pct": ["sweet_spot_pct", "sweet_spot_percent", "sweet_spot%", "launch", "line"],
    "barrel_pct": ["barrel_pct", "barrel_batted_rate", "barrel_percent", "barrel%"],
    "hard_hit_pct": ["hard_hit_pct", "hard_hit_percent", "hardhit%", "hh%", "cond"],
    "dmg": ["dmg", "damage", "xslg", "dmg_score"],
    "hr_pa": ["hr_pa", "hr/pa", "b_home_run", "hr_rate", "hr%"],
    "hpi": ["hpi", "ult", "adj", "hr_power_index", "xwoba"],
}
